...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: number, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async resetSeedFlag(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetSeedFlag();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: number, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
